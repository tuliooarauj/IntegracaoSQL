...
public class ConexaoMySql {
    ...
    private final static String URL = "jdbc:mysql://127.0.0.1/db_managehotel"; //endereço da base de dados do seu projeto, deve ser a mesma configurada lá no SGBD
    private final static String USUARIO = "root"; //usuário de acesso ao SGBD
    private final static String SENHA = "158062rn"; //senha do usuário acima
    /**
    ...
    public static boolean atualizar(String sql) {
        ...
        try {
            ...
            if (sqlException.getErrorCode() == 1451) { //se for erro/bloqueio de chave estrangeira
                ...
                JOptionPane.showMessageDialog(null, "Não é possível executar esta ação! "
                        + " Talvez exista algum erro no script SQL. Revise-o!");
            }
            result = false;
        }
        return result;
